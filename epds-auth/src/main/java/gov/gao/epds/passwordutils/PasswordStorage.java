package gov.gao.epds.passwordutils;
 ...
 * @author MHussaini
 *
 *Amer : I think it will be more secure if we store all the constants in the Properties File and encrypt it at rest and decrypt it at run time
 *
 */
public class PasswordStorage {
	...
	public static String createHash(char[] password)
		...
		String parts = "sha2:" + PBKDF2_ITERATIONS + ":" + hashSize + ":"
	...
	public static boolean verifyPassword(char[] password, String correctHash)
		...
		if (!params[HASH_ALGORITHM_INDEX].equals("sha2")) {
		...
		// debugger gets confused if step over
