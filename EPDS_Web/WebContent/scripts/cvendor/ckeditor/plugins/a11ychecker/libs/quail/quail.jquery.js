...
$.expr.pseudos.quailCss = function(obj, index, meta) {
...
quail.lib.wcag2.TestAggregator = (function () {
  ...
  function getCombinedAssertions(aggregator, tests) {
    ...
    var elms = jQuery.uniqueSort(getCommonElements(tests));

    var assertions = createAssertionsForEachElement(jQuery.uniqueSort(elms), {
