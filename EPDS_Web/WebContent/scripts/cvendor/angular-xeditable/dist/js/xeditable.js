...
angular.module('xeditable').directive('editableBsdate', ['editableDirectiveFactory', '$injector', '$parse',
    function(editableDirectiveFactory, $injector, $parse) {
        ...
        return editableDirectiveFactory({
            ...
            autosubmit: function() {
                var self = this;
                self.inputEl.on('change', function() {
                    setTimeout(function() {
                ...
                self.inputEl.on('keydown', function(e) {
                    //submit on tab
  ...
  function(editableDirectiveFactory, editableCombodate) {
    return editableDirectiveFactory({
      ...
      render: function() {
        ...
        combodate.$widget.find('select').on('change', function(e) {
      ...
      function EditableController($scope, $attrs, $element, $parse, editableThemes, editableIcons, editableOptions, $rootScope, $compile, $q, $sce, $templateCache) {
        ...
        */
        self.addListeners = function () {
          ...
          self.inputEl.on('keyup', function (e) {
            if (!self.single) {
              return;
            }
          ...
          self.editorEl.on('click', function (e) {
        ...
        */
        ...
        // !hasForm
          ...
          if(!attrs.eForm || attrs.eClickable) {
            ...
            elem.on(editableOptions.activationEvent, function(e) {
              e.preventDefault();
              e.editable = eCtrl;
              if(!is_disabled()) {
  ...
  Combodate.prototype = {
    ...
    init: function () {
      ...
      if (this.options.smartDays) {
        var combo = this;
        this.$widget.find('select').on('change', function(e) {
